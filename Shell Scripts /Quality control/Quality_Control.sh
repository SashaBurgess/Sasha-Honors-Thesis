...
STAR --runMode genomeGenerate --genomeDir $workingDir"sasha_star/second_index" --genomeFastaFiles $workingDir"Drosophila_melanogaster.BDGP6.32/"* --sjdbFileChrStartEnd $workingDir"sasha_star/first_pass/SJ.out.tab" --sjdbOverhang 49 --runThreadN 20
